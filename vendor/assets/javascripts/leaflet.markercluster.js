      ...
      if (this._map) {
        var _ = 0,
          ...
          l = L.bind(function() {
            ...
            h && h(_, t.length, (new Date).getTime() - u), _ === t.length ? (this._featureGroup.eachLayer(function(t) {
              t instanceof L.MarkerCluster && t._iconNeedsUpdate && t._updateIcon()
            }), this._topClusterLevel._recursivelyAddChildrenToMap(null, this._zoom, this._currentShownBounds)) : setTimeout(l, this.options.chunkDelay)
          }, this);
        l()
      } else {
